...
// create app that creates a console app to allow for calculations, whie at the same time creating a program to handle if user inputs text instead of number
